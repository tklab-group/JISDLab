...
```
3. Access http://localhost:21510 and enter a password(an initial password is `passwd`)
4. Success if [debugspace/DemoForDocker.ipynb](debugspace/DemoForDocker.ipynb) can be executed from the Jupyter client.
