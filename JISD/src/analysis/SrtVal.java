...
/**
 * This class corresponds to one valuable.
 * Also analyze valuable and get the type and whether it can be set as breakpoint.
 */
public class SrtVal{
  ...
  /**
   * the valuable type name
   * (eg. "int", "java.lang.String", "Student", "int[]", "int[][]")
   */
   ...
   * @param cnKeySet set of ClassNode key 
   *        (used to get whether the valuable type is user-defined or not)
   */
