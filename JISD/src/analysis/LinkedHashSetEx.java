...
/**
 * Customized version of LinkedHashSet. You can access the elements randomly to
 * get an specific element or subset. <br>
 * 
...
public class LinkedHashSetEx<E> extends LinkedHashSet<E> {
  ...
  /**
   * Get the value of the first element. (when this method is called, the instance
  ...
  /**
   * Get the value of the last element. (when this method is called, the instance
   * should have at least one element)
   * 
   * @return last value
   */
  ...
  /**
   * Get the index of the element which equals to the specified value. When the
   * element not exist, the next index of the last element is returned.
   * 
