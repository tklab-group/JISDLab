 ...
 * call {@linkplain Files#walkFileTree} with the instance as one of its arguments. 
 */
public class ClassFileVisitor implements FileVisitor<Path> {
   ...
   * @param offset offset to remove first several letters from the full paths of class files
   *               (eg. when setting 4 offset, "bin\src\Test.class" -> "src\Test.class")
   */
