...
class DebugResultManager {
   ...
   */
  void addVariable(BreakPoint bp, String className, int lineNumber, String varName, Location loc,
    ...
    synchronized (this) {
      ...
      DebugResult dr = new DebugResult(maxRecordNoOfValue, maxNoOfExpand, number++, className, lineNumber, varName, loc,
          entry);
      drs.add(dr);
